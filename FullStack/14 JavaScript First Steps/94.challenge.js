...
// It will take your current age as the input and console.logs a message with our time 
// left in this format:
// You have x days, y weeks, and z months left.
// Where x, y and z are replaced with the actual calculated numbers.
// For this challenge, assume there are 365 days in a year, 52 weeks in a year and 12 
// months in a year.
// IMPORTANT your console.log output should match the Example Output format exactly, 
...
function lifeInWeeks(age){
    let limit = 90;
    let leftAges = limit - age;
    let leftMonths = leftAges * 12;
    let leftWeeks = leftAges * 52;
    let leftDays = leftAges * 365;
