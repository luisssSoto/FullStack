...
app.post("/submit", (req, res) => {
  ...
  let firstAlias = adj[Math.round(Math.random() * (adj.length - 1))]
  let secondAlias = noun[Math.round(Math.random() * (noun.length - 1))];
  let bandName = firstAlias + " " + secondAlias;
  res.render("index.ejs", {aliasName: bandName});
});
